...
void VoronoiDiagramGenerator::pushGraphEdge(double x1, double y1, double x2, double y2, double xx1, double yy1, double xx2, double yy2)
{
...
void VoronoiDiagramGenerator::line(double x1, double y1, double x2, double y2, double xx1, double yy1, double xx2, double yy2) // xx1,yy1 are the sites generating this edge
{	
	pushGraphEdge(x1,y1,x2,y2,xx1,yy1,xx2,yy2);
...
//	std::cout <<  x1 << " " << y1 << " " << x2 << " " << y2 << " " << e->reg[0]->coord.x << " " << e->reg[0]->coord.y << " " << e->reg[1]->coord.x << " " << e->reg[1]->coord.y << std::endl;
	line(x1,y1,x2,y2,e->reg[0]->coord.x,e->reg[0]->coord.y,e->reg[1]->coord.x,e->reg[1]->coord.y);
}
